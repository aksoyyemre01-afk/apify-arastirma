...
def is_relevant(media_path: Path, kind: str, query: str, note: str, company: str = "") -> bool:
    ...
    try:
        ...
        prompt = (
            ...
            "bir jenerik kelimeyle yüzeysel eşleşiyor ama aslında bambaşka, alakasız bir "
            "sektöre/markaya/yere aitse HAYIR de. Somut örnekler:\n"
            "- Sahne bir kamera/telefon şirketiyle ilgiliyken görsel rastgele bir benzin "
            "istasyonunun kepenkleriyse -> HAYIR\n"
            "- Sahne bir kriz anıyla ilgiliyken görsel iki kişinin gülümseyerek tokalaştığı "
            "alakasız bir kurumsal fotoğrafsa -> HAYIR\n"
            "- Sahne 'eski/vintage bir bilgisayar' ile ilgiliyken görsel spesifik olarak "
            "başka bir markaya ait tanınabilir bir bilgisayar/cihazsa (ör. sahnenin "
            "şirketiyle alakasız bir Commodore/Atari) -> HAYIR\n"
            "- Sahne genel bir 'alarm/kriz' hissi istiyorken görsel gerçek bir bina yangın "
            "alarmı/duman dedektörü gibi iş dünyasıyla hiç ilgisi olmayan somut bir "
            "nesneyse -> HAYIR\n"
            "- Sahne belirli bir şirket/binasıyla ilgiliyken görsel rastgele, markasız, "
            "jenerik bir cam ofis binasıysa (hangi şirket olduğu hiç belli değilse) -> HAYIR\n"
            "Emin değilsen de HAYIR de - EVET demek için görselin konuyla gerçekten "
            "örtüştüğünden emin olmalısın. Sadece tek kelime cevap ver: EVET ya da HAYIR."
        )
